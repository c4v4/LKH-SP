...
/**
 * Definition inside LKH headers are moved here to avoid fcommon flag
 * and for compatibility with C++ code.
 */
...
int CandidateSetSymmetric, CandidateSetType, Capacity, CoordType, DelaunayPartitioning, DelaunayPure, ExternalSalesmen,
    ...
    PatchingCRestricted, RiskThreshold, RohePartitioning, Salesmen, SalesmenUsed, SierpinskiPartitioning, SubproblemBorders, SubproblemsCompressed,
...
/////// gpx.h ///////
int n_cities, n_cand;
int n_partitions_size2, n_partitions_before_fusion, n_partitions_after_fusion1, n_partitions_after_fusion2, n_partitions_after_fusion3;
