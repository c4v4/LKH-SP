...
void ReadParameters() {
    ...
    while ((Line = ReadLine(ParameterFile))) {
        ...
        if (!strcmp(Keyword, "ASCENT_CANDIDATES")) {
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &AscentCandidates))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &BackboneTrials))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &BWTSP_B))
                eprintf("BWTSP: integer expected");
            if (BWTSP_B <= 0)
                eprintf("BWTSP: positive integer expected");
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &BWTSP_Q))
                eprintf("BWTSP: second integer expected");
            if (BWTSP_Q <= 0)
                eprintf("BWTSP: positive integer expected");
            if ((Token = strtok(0, Delimiters)) && !sscanf(Token, "%d", &BWTSP_L))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &MTSPDepot))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%lf", &Excess))
                eprintf("EXCESS: real expected");
            if (Excess < 0)
                eprintf("EXCESS: non-negeative real expected");
        } else if (!strcmp(Keyword, "EXTERNAL_SALESMEN")) {
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &ExternalSalesmen))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &ExtraCandidates))
            ...
            if ((Token = strtok(0, Delimiters))) {
                ...
                if (strncmp(Token, "SYMMETRIC", strlen(Token)))
                    eprintf("(EXTRA_CANDIDATES) Illegal SYMMETRIC specification");
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &InitialPeriod))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &InitialStepSize))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &KickType))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &Kicks))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &MaxBreadth))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &MaxCandidates))
            ...
            eprintf("MOVE_TYPE Const, cannot be changed.");
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &MTSPMaxSize))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &MTSPMinSize))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &NonsequentialMoveType))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &PatchingA))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &PatchingC))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &POPMUSIC_MaxNeighbors))
                eprintf("POPMUSIC_MAX_NEIGHBORS: integer expected");
            if (POPMUSIC_MaxNeighbors <= 0)
                eprintf("POPMUSIC_MAX_NEIGHBORS: positive integer expected");
        } else if (!strcmp(Keyword, "POPMUSIC_SAMPLE_SIZE")) {
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &POPMUSIC_SampleSize))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &POPMUSIC_Solutions))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &POPMUSIC_Trials))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &MaxPopulationSize))
                eprintf("POPULATION_SIZE: integer expected");
        } else if (!strcmp(Keyword, "PRECISION")) {
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &Precision))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &SubproblemSize))
            ...
            eprintf("SUBSEQUENT_MOVE_TYPE Const, cannot be changed.");
            /* if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &SubsequentMoveType))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%lf", &TimeLimit))
            ...
            if (!(Token = strtok(0, Delimiters)) || !sscanf(Token, "%d", &TraceLevel))
