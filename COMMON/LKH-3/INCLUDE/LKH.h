...
extern int BWTSP_Q;            /* Maximum number of subsequent white nodes in a
                           BWTSP instance */
extern int BWTSP_L;            /* Maximum length of any path between two black nodes
                           in a BTWSP instance */
...
extern const int MoveType;             /* Specifies the sequantial move type to be used
                             in local search. A value K >= 2 signifies
                             that a k-opt moves are tried for k <= K */
extern const int MoveTypeSpecial;      /* A special (3- or 5-opt) move is used */
...
extern const int SubsequentMoveType;        /* Specifies the move type to be used for all
                                  moves following the first move in a sequence
                                  of moves. The value K >= 2 signifies that a
                                  K-opt move is to be used */
extern const int SubsequentMoveTypeSpecial; /* A special (3- or 5-opt) subsequent move
                                  is used */
...
GainType BridgeGain(Node *s1, Node *s2, Node *s3, Node *s4, Node *s5, Node *s6, Node *s7, Node *s8, int Case6, GainType G);
